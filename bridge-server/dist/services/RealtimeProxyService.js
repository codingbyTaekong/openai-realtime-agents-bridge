...
exports.RealtimeProxyService = void 0;
 ...
 */
class RealtimeProxyService extends events_1.EventEmitter {
    constructor(options) {
        super();
        this.openaiWs = null;
    ...
    async connect() {
        return new Promise((resolve, reject) => {
            try {
                ...
                this.openaiWs = new ws_1.default(wsUrl, {
                    headers: {
    ...
    sendToOpenAI(message) {
        if (!this.openaiWs || this.openaiWs.readyState !== ws_1.default.OPEN) {
     ...
     */
    get connected() {
        return this.isConnected && this.openaiWs?.readyState === ws_1.default.OPEN;
    }
    /**
     * 세션 설정 업데이트
     */
...
exports.RealtimeProxyService = RealtimeProxyService;
//# sourceMappingURL=RealtimeProxyService.js.map